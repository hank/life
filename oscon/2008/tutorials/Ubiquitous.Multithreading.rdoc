= OSCON 2008, Tutorial 3: Ubiquitous Multithreading in a Multicore World
...
=== Generic iteration
- Dependences hinder paralell execution
...
- Search returns one of several accepable answers
